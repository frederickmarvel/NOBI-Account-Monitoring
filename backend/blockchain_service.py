...
class BlockchainService:
    ...
    WHITELISTED_SOLANA_TOKENS = {
        ...
        '2b1kv6dkpanxd5ixfnxcpjxmkwqjjaaymczfhsfu24gxo': {'symbol': 'PYUSD', 'name': 'PayPal USD', 'decimals': 6},  # Correct PayPal USD
        'so11111111111111111111111111111111111111112': {'symbol': 'WSOL', 'name': 'Wrapped SOL', 'decimals': 9},
        '27g8mtk7vttcchkpasjsddkwwyfoqt6ggeukidvjid4': {'symbol': 'JLP', 'name': 'Jupiter Perps LP', 'decimals': 6},  # Correct JLP
        '5ovnbeeqvyi1cx3ir8dx5n1p7pdxydbgf2x4txvusjm': {'symbol': 'INF', 'name': 'Infinity', 'decimals': 9},  # Correct INF
    }
